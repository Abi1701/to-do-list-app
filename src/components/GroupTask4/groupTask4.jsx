...
import styled from "./groupTask4.module.scss";
...
export default function GroupTask4() {
	...
	return (
		<div className={styled.groupTask4}>
			<div className={styled.groupTaskContainer}>
				<div className={styled.tittleTask}>Group Task 4</div>
				<p className={styled.monthTask}>October - December</p>
