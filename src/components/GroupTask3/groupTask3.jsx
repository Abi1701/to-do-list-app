...
import styled from "./groupTask3.module.scss";
...
export default function GroupTask3() {
	...
	return (
		<div className={styled.groupTask3}>
			<div className={styled.groupTaskContainer}>
				<div className={styled.tittleTask}>Group Task 3</div>
				<p className={styled.monthTask}>July - September</p>
