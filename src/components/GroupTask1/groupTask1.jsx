...
import styled from "./groupTask1.module.scss";
import PlusCircle from "../../assets/plusCircle.svg";
import Modal from "react-modal";
import ToDos from "../to-do/toDo";
const customStyles = {
	content: {
		top: "50%",
		left: "50%",
...
export default function GroupTask1() {
	...
	return (
		<div className={styled.groupTask1}>
			<div className={styled.groupTaskContainer}>
				<div className={styled.tittleTask}>Group Task 1</div>
				<p className={styled.monthTask}>January - March</p>
				<ToDos />
